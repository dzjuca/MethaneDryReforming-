...
% ----- CH4 species -------------------------------------------------------
    u1bt = -(RH1Fcn(alpha,ub,u1b,Global,'FGBurbuja')).*FC1              ...
           ...
           +(RH4Fcn(alpha,CTBW,Global,u8b,'FGBurbuja','CH4')).*FC1;
% ----- CO2 species -------------------------------------------------------
    u2bt = -(RH1Fcn(alpha,ub,u2b,Global,'FGBurbuja')).*FC1              ...
           ...
           +(RH4Fcn(alpha,CTBW,Global,u8b,'FGBurbuja','CO2')).*FC1;
% ----- CO species --------------------------------------------------------
    u3bt = -(RH1Fcn(alpha,ub,u3b,Global,'FGBurbuja')).*FC1              ...
           ...
           +(RH4Fcn(alpha,CTBW,Global,u8b,'FGBurbuja','CO')).*FC1;
% ----- H2 species --------------------------------------------------------
    u4bt = -(RH1Fcn(alpha,ub,u4b,Global,'FGBurbuja')).*FC1              ...
           ...
           +(RH4Fcn(alpha,CTBW,Global,u8b,'FGBurbuja','H2')).*FC1;
% ----- H2O species -------------------------------------------------------
    u5bt = -(RH1Fcn(alpha,ub,u5b,Global,'FGBurbuja')).*FC1              ...
           ...
           +(RH4Fcn(alpha,CTBW,Global,u8b,'FGBurbuja','H2O')).*FC1;
% ----- N2 species --------------------------------------------------------
    u6bt = -(RH1Fcn(alpha,ub,u6b,Global,'FGBurbuja')).*FC1              ...
           ...
           +(RH4Fcn(alpha,CTBW,Global,u8b,'FGBurbuja','N2')).*FC1;
...
% ----- CH4 species -------------------------------------------------------
    u1et = -(RH1Fcn(alpha,ue,u1e,Global,'FGEmulsion')).*FC2             ...
           ...
           +(RH4Fcn(alpha,CTE,Global,u8e,'FGEmulsion','CH4')).*FC2;
% ----- CO2 species -------------------------------------------------------
    u2et = -(RH1Fcn(alpha,ue,u2e,Global,'FGEmulsion')).*FC2             ...
           ...
           +(RH4Fcn(alpha,CTE,Global,u8e,'FGEmulsion','CO2')).*FC2;
% ----- CO species --------------------------------------------------------
    u3et = -(RH1Fcn(alpha,ue,u3e,Global,'FGEmulsion')).*FC2             ...
           ...
           +(RH4Fcn(alpha,CTE,Global,u8e,'FGEmulsion','CO')).*FC2;
% ----- H2 species --------------------------------------------------------
    u4et = -(RH1Fcn(alpha,ue,u4e,Global,'FGEmulsion')).*FC2             ...
           ...
           +(RH4Fcn(alpha,CTE,Global,u8e,'FGEmulsion','H2')).*FC2;
% ----- H2O species -------------------------------------------------------
    u5et = -(RH1Fcn(alpha,ue,u5e,Global,'FGEmulsion')).*FC2             ...
           ...
           +(RH4Fcn(alpha,CTE,Global,u8e,'FGEmulsion','H2O')).*FC2;
% ----- N2 species --------------------------------------------------------
    u6et = -(RH1Fcn(alpha,ue,u6e,Global,'FGEmulsion')).*FC2             ...
           ...
           +(RH4Fcn(alpha,CTE,Global,u8e,'FGEmulsion','N2')).*FC2;
...
% ----- Coke species ------------------------------------------------------
    u7wt = -RH1Fcn(alpha,ub,u7w,Global,'FSEstela').*FC3                 ...
           ...
           +RH4Fcn(alpha,CTBW,Global,u8b,'FSEstela','Cc').*FC3;
...
% ----- Coke species ------------------------------------------------------
    u7et = +RH1Fcn(alpha,us,u7e,Global,'FSEmulsion').*FC4               ...
           ...
           +RH4Fcn(alpha,CTE,Global,u8e,'FSEmulsion','Cc').*FC4;
% -------------------------------------------------------------------------
% -------------------------------------------------------------------------
% -------------------------------------------------------------------------
% -------------------------------------------------------------------------
...
% ----- constant value ----------------------------------------------------
    idEP  = 'emulsion';
    EBCF2 = 1./eblhsFcn( alpha, Global, CTE, u8e, idEP);
    u8et  = (- ebrhs1Fcn(alpha, Global, CTE, u8e, [ue,us], idEP)      ...
             - ebrhs2Fcn(alpha, Global, CTBW, CTE, u8b, u8e, ub, db)  ...
             + ebrhs3Fcn(alpha, Global, CTE, u8e, idEP)               ...
             - ebrhs4Fcn(alpha, Global, CTBW, CTE, u8b, u8e, ub)      ...
             - ebrhs5Fcn(alpha, Global,  u8b, u8e, ub)                ...
             + ebrhs6Fcn(alpha, Global,  u8e, CTE, db)).*EBCF2; 
% -------------------------------------------------------------------------
% -------------------------------------------------------------------------
% -------------------------------------------------------------------------
% -------------------------------------------------------------------------
