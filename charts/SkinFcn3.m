function [CiBW,CiE,CsW,CsE] = SkinFcn3(t,u)
  global zg A fw Emf 
...
%   for ii = 1:index3
   fig1 = figure;
    ...
    hold on
    for i = 1:index2
            plot(tmin,CsW(:,i),'ko-','MarkerSize',3);
    end 
    xlabel('$tiempo\;\left( {min} \right)$',...
           'FontSize',16,'interpreter','Latex')
    ylabel(TAG1(7),...
...
%   for ii = 1:index3
   fig1 = figure;
    ...
    hold on
    for i = 1:index2
            plot(tmin,CsE(:,i),'ko-','MarkerSize',3);
    end 
    xlabel('$tiempo\;\left( {min} \right)$',...
           'FontSize',16,'interpreter','Latex')
    ylabel(TAG1(7),...
