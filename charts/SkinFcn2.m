...
% -------------------------------------------------------------------------
    for j=1:index1 
        for i=1:index2, u1e(j,i)=u(j,i+0*index2);     end
        for i=1:index2, u2e(j,i)=u(j,i+1*index2);     end
        for i=1:index2, u3e(j,i)=u(j,i+2*index2);     end
        for i=1:index2, u4e(j,i)=u(j,i+3*index2);     end
        for i=1:index2, u5e(j,i)=u(j,i+4*index2);     end 
        for i=1:index2, u6e(j,i)=u(j,i+5*index2);     end 
    end
